...
const AsarListMobile = ({ search, auditory_age__in, text_type_id__in }) => {
    ...
    const { data, status, error, fetchNextPage, isFetchingNextPage, hasNextPage } = useInfiniteQuery({
        ...
        queryFn: async ({ pageParam }: { pageParam: number }) => {
            setEnabled(false);
            return await worksGetApi({ search, page: pageParam, auditory_age__in, text_type_id__in });
        },
        initialPageParam: 1,
            ...
            <div className="w-full lg:w-[85vw] mx-auto px-4 pb-10">
                ...
                <div className="hidden lg:block bg-white shadow-lg rounded-lg pb-5">
                    <div className={` overflow-hidden px-4 pt-6`}>
                        ...
                        <AsarList search={search} auditory_age__in={auditory_age__in} text_type_id__in={text_type_id__in} h={h} />
                    </div>
                </div>
                ...
                <div className="block lg:hidden ">
                    ...
                    <AsarListMobile search={search} auditory_age__in={auditory_age__in} text_type_id__in={text_type_id__in} />
                </div>
            </div>
        </div>
    )
